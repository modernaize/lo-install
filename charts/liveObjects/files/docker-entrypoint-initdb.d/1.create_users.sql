...
insert into :auth_schema.menu_item(id, parent_id,title,order_id,title_type,placement_location,url_path,icon_path,update_timestamptz, iframe) values
    ...
    ,now(), NULL),
    (11,0,'Settings',8, 'TEXT','TOP','/settings','',now(), NULL),
