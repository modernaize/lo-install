...
insert into :auth_schema.menu_item(id, parent_id,title,order_id,title_type,placement_location,url_path,icon_path,update_timestamptz) values
    ...
    (12,0,'License Manager',9, 'TEXT','LEFT','/license-manager',
    ...
    ,now()),
    (13,0,'System Manager',10, 'TEXT','LEFT','/',
    ...
    ,now()),
    (14,13,'Commit Log',1, 'TEXT','LEFT','/commit-log',
    '<svg width="12" height="24" viewBox="0 0 12 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M4.64998 0.300003V7.0128C2.50618 7.6134 0.918579 9.5802 0.918579 11.9064C0.918579 14.2326 2.50618 16.218 4.64998 16.8186V23.7H7.36858V16.8186C9.51238 16.218 11.1 14.2326 11.1 11.9064C11.1 9.5802 9.51238 7.6134 7.36858 7.0128V0.300003H4.64998ZM6.01858 9.525C7.34758 9.525 8.38138 10.5774 8.38138 11.9064C8.38138 13.2354 7.34758 14.2872 6.01858 14.2872C4.68958 14.2872 3.63718 13.2354 3.63718 11.9064C3.63718 10.5774 4.68958 9.525 6.01858 9.525Z" fill="#45C197"/></svg>'
    ,now());
INSERT INTO :auth_schema.menu_item(id, parent_id, title, order_id, title_type, placement_location, url_path, update_timestamptz, icon_path)
VALUES
    (15, 0, 'Manage Projects', 11, 'TEXT', 'LEFT', '/projects', now(),
    ...
    (16, 0, 'Manage Users', 12, 'TEXT', 'LEFT', '/manage-users', now(),
    ...
    (17, 0, 'Process Exploration', 7, 'TEXT', 'LEFT', '/process-discovery', now(),
    ...
    (18, 0, 'Configuration', 13, 'TEXT', 'LEFT', '/', now(),
    ...
    (19, 18, 'Authorization', 1, 'TEXT', 'LEFT', '/configuration', now(),
    ...
    (20, 0, 'System Configuration', 14, 'TEXT', 'LEFT', '/system-configuration', now(),
    ...
    (21, 0, 'Business Dictionaries', 15, 'TEXT', 'LEFT', '/business-dictionary', now(),
...
INSERT INTO :auth_schema.user(name, username, email, password, project_id, password_reset_needed, secret_2fa, enable_2fa, timezone)
VALUES ('root', 'root', 'root@liveobjects.ai', '$2a$10$89Ll/WqxDz4XHwsyTxVYV.kjvekxhrDbe964EaZoJBwnZ5OwPJD06', 1, TRUE, '3ZYMZNAMQGRNSTEJ', FALSE, 130);
INSERT INTO :auth_schema.user(name, username, email, password, project_id, password_reset_needed, secret_2fa, enable_2fa, timezone)
VALUES ('admin', 'admin', 'support@liveobjects.ai', '$2a$10$89Ll/WqxDz4XHwsyTxVYV.kjvekxhrDbe964EaZoJBwnZ5OwPJD06', 1, TRUE, '3ZYMZNAMQGRNSTEJ', FALSE, 130);
INSERT INTO :auth_schema.user(name, username, email, password, project_id, password_reset_needed, secret_2fa, enable_2fa, timezone)
VALUES ('license_admin', 'license_admin', 'licences@liveobjects.ai', '$2a$10$89Ll/WqxDz4XHwsyTxVYV.kjvekxhrDbe964EaZoJBwnZ5OwPJD06', 1, TRUE, '3ZYMZNAMQGRNSTEJ', FALSE, 130);
INSERT INTO :auth_schema.user(name, username, email, password, project_id, password_reset_needed, secret_2fa, enable_2fa, timezone)
VALUES ('system_admin', 'system_admin', 'system_admin@liveobjects.ai', '$2a$10$89Ll/WqxDz4XHwsyTxVYV.kjvekxhrDbe964EaZoJBwnZ5OwPJD06', 1, TRUE, '3ZYMZNAMQGRNSTEJ', FALSE, 130);
...
-- ROLE_ADMIN
    ...
    VALUES
        ...
        ('1', 1, 21, 2, 3, 1, 1, 9000, 1, 1),
        -- all
        ('1', 1, 22, 2, 3, 1, 1, 9000, 1, 1),
        -- system configuration
        ('1', 1, 20, 2, 3, 1, 1, 9000, 1, 1);
...
-- ROLE_SYSTEM_ADMIN
    ...
    VALUES
        ...
        -- configuration
        ('1', 1, 18, 2, 3, 6, 1, 9000, 1, 1),
        -- configuration > authorization
        ('1', 1, 19, 2, 3, 6, 1, 9000, 1, 1),
        -- system configuration
